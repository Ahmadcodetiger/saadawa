  ...
  async purchaseAirtime(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      try {
        ...
        return ApiResponse.error(res, error.response?.data?.message || error.response?.data?.msg || error.message || 'Airtime purchase failed', 400);
      }
    } catch (error) {
      next(error);
    }
  ...
  async purchaseData(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      try {
        ...
        return ApiResponse.error(res, error.message || 'Data purchase failed', 400);
      }
    } catch (error) {
      next(error);
    }
  ...
  async purchaseCableTV(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      try {
        ...
        return ApiResponse.error(res, error.message || 'Cable TV purchase failed', 400);
      }
    } catch (error) {
      next(error);
    }
  ...
  async purchaseElectricity(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      try {
        ...
        return ApiResponse.error(res, error.message || 'Electricity purchase failed', 400);
      }
    } catch (error) {
      next(error);
    }
  ...
  async purchaseExamPin(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      try {
        ...
        return ApiResponse.error(res, error.message || 'Exam pin purchase failed', 400);
      }
    } catch (error) {
      next(error);
    }
